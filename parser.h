 ...
 * It is recommended that you use this function after executing the commands
 * inside the parsed_input struct.
 * @param input
 */
 ...
 * You should look at how different inputs are stored to understand how
 * parse_line works. Please do not forget to delete this before submission to
 * prevent unnecessary output from being printed.
 * @param input
 */
